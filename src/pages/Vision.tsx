    ...
    <div className="space-y-6 animate-fade-in text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {!imageSrc ? (
            /* Upload box */
            <div className="bg-white dark:bg-slate-900 border-2 border-dashed border-slate-200 dark:border-slate-850 rounded-2xl p-8 sm:p-12 text-center shadow-xs flex flex-col items-center justify-center gap-4 transition-all hover:border-teal-500/30">
              <div className="p-4 bg-teal-50 dark:bg-teal-950/40 text-teal-600 dark:text-teal-400 rounded-2xl">
                <Camera className="w-10 h-10" />
              </div>
              <div className="space-y-2">
                <h3 className="font-bold text-lg text-slate-800 dark:text-slate-200">ถ่ายรูปหรืออัปโหลดภาพสมุนไพร</h3>
                <p className="text-xs text-slate-400 dark:text-slate-500 max-w-sm leading-relaxed">
                  รองรับการอัปโหลดไฟล์ภาพสกุล JPG, PNG หรือสามารถเปิดกล้องโทรศัพท์เพื่อกดถ่ายรูปแปลงสมุนไพรโดยตรง
                </p>
              </div>
              
              <button
                onClick={triggerUpload}
                className="px-6 py-2.5 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-sm font-bold shadow-sm hover:shadow-teal-600/10 transition-all cursor-pointer"
              >
                เลือกจากคลังรูปภาพ / เปิดกล้อง
              </button>
